...
function love.load()
 ...
 -- for i=1, 10 do
 --   walls[#walls+1] = {pos=vector(love.math.random(w-10), 0), h=love.math.random(10, 200)}
 --   walls2[#walls2+1] = {pos=vector(love.math.random(w-10), 0), h=love.math.random(10, 200)}
 -- end
end
...
function love.draw()
 ...
 love.graphics.print(string.format("score: %d | health: %d", body.score, body.health), 10, 10)
end
